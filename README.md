...
Pedagogical [graphden](https://github.com/BonsaiFlow/graphden) fn-def examples —
...
```clojure
;; deps.edn (dev alias)
{:aliases {:dev {:extra-deps {com.bonsaiflow/graphden-examples
                              {:git/url "git@github.com:BonsaiFlow/graphden-examples.git"
                               :git/sha "<sha>"}}}}}
```
